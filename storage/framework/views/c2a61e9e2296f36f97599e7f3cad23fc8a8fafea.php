            ...
            <div class="row">
              <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                <div class="login-brand">
                  <img src="<?php echo e(asset('assets/img/logosmk.png')); ?>" alt="logo" width="120" class="">
                </div>
...
unset($__errorArgs, $__bag); ?>" name="email"  tabindex="1" autocomplete="off" value="<?php echo e(old('email')); ?>" required autofocus>
...
<?php /**PATH C:\Users\shata\OneDrive\Documents\pengkodean\pembayaran-spp\resources\views/auth/login.blade.php ENDPATH**/ ?>